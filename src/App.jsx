...
function App() {
  return (
    <main className='min-h-screen flex flex-col items-center justify-evenly gap-8'>
      <section className='flex flex-col items-center justify-center gap-9 bg-stars px-4'>
